...
export default function Nav ({ publicRepos }: Props): JSX.Element {
  return (
    <>
      <div className='navgit'>
        <Container>
          <Col md={{ offset: 3 }}>
            <nav className='navgit-menu'>
              <Link to='/' className='navgit-item'>
                <svg
                  aria-hidden='true'
                  height='16'
                  viewBox='0 0 16 16'
              ...
              >
                ...
                Repositories
                <span className='counter'>{publicRepos}</span>
              </NavLink>
              <Link to='/' className='navgit-item'>
                <svg
                  aria-hidden='true'
