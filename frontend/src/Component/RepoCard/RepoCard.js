    ...
    <Container className="mb-3">
      ...
      <Row>
        <div>
          <h3>
            <Link
              to={`https://github.com/${props.username}/${repoName}`}
              className="repo-link">
              {repoName}
            </Link>
        ...
        <div className="repo-info">
          {props.r.language && (
            <div className="repo-info_item">
              <div className={`repo-info_languageColor ${props.r.language}`} />
              <span>{props.r.language}</span>
            </div>
          )}
          {props.r.stargazers_count > 0 ? (
            <div className="repo-info_item">
              <span>
                <svg
                  aria-label="star"
                ...
                {props.r.stargazers_count}
              </span>
            </div>
          ) : null}
          {Number(props.r.forks_count) > 0 ? (
            <div className="repo-info_item">
              <span>
                <svg
                  aria-label="fork"
